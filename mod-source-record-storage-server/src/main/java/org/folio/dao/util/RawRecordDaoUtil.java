...
public final class RawRecordDaoUtil {
  ...
  /**
   * Searches for {@link RawRecord} by id using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param id            id
   * @return future with optional RawRecord
   */
  public static Future<Optional<RawRecord>> findById(CommonQueryExecutor queryExecutor, String id) {
  ...
  /**
   * Saves {@link RawRecord} to the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param rawRecord     raw record
   * @return future with updated RawRecord
   */
  public static Future<RawRecord> save(CommonQueryExecutor queryExecutor, RawRecord rawRecord) {
    RawRecordsLbRecord dbRecord = toDatabaseRawRecord(rawRecord);
