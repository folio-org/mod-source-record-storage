...
public final class RecordDaoUtil {
   ...
   * @return future with optional Record
   */
  public static Future<Optional<Record>> findByCondition(CommonQueryExecutor queryExecutor, Condition condition) {
  ...
  /**
   * Searches for {@link Record} by id using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param id            id
   * @return future with optional Record
   */
  public static Future<Optional<Record>> findById(CommonQueryExecutor queryExecutor, String id) {
  ...
  /**
   * Saves {@link Record} to the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param record        record
   * @return future with updated Record
   */
  public static Future<Record> save(CommonQueryExecutor queryExecutor, Record record) {
    RecordsLbRecord dbRecord = toDatabaseRecord(record);
  ...
  /**
   * Updates {@link Record} to the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param record        record to update
   * @return future of updated Record
   */
  public static Future<Record> update(CommonQueryExecutor queryExecutor, Record record) {
    RecordsLbRecord dbRecord = toDatabaseRecord(record);
