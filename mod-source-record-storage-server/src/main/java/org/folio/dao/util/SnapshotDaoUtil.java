...
public final class SnapshotDaoUtil {
  ...
  /**
   * Searches for {@link Snapshot} by {@link Condition} and ordered by collection of {@link OrderField} with offset and limit
   * using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param condition     condition
   * @param orderFields   fields to order by
   ...
   * @return future with {@link List} of {@link Snapshot}
   */
  public static Future<List<Snapshot>> findByCondition(CommonQueryExecutor queryExecutor, Condition condition,
                                                       Collection<OrderField<?>> orderFields, int offset, int limit) {
   ...
   * @return future with count
   */
  public static Future<Integer> countByCondition(CommonQueryExecutor queryExecutor, Condition condition) {
  ...
  /**
   * Searches for {@link Snapshot} by id using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param id            id
   * @return future with optional Snapshot
   */
  public static Future<Optional<Snapshot>> findById(CommonQueryExecutor queryExecutor, String id) {
  ...
  /**
   * Saves {@link Snapshot} to the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param snapshot      snapshot
   * @return future with updated Snapshot
  ...
  public static Future<Snapshot> save(CommonQueryExecutor queryExecutor, Snapshot snapshot) {
    SnapshotsLbRecord dbRecord = toDatabaseRecord(setProcessingStartedDate(snapshot));
  ...
  /**
   * Saves {@link List} of {@link Snapshot} to the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param snapshots     list of snapshots
   * @return future with updated List of Snapshot
   */
  public static Future<List<Snapshot>> save(CommonQueryExecutor queryExecutor, List<Snapshot> snapshots) {
  ...
  /**
   * Updates {@link Snapshot} in the db using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param snapshot      snapshot to update
   * @return future of updated Snapshot
   */
  public static Future<Snapshot> update(CommonQueryExecutor queryExecutor, Snapshot snapshot) {
    SnapshotsLbRecord dbRecord = toDatabaseRecord(setProcessingStartedDate(snapshot));
  ...
  /**
   * Deletes {@link Snapshot} by id using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @param id            id
   * @return future with boolean whether Snapshot deleted
   */
  public static Future<Boolean> delete(CommonQueryExecutor queryExecutor, String id) {
    return queryExecutor.execute(dsl -> dsl
  ...
  /**
   * Deletes all {@link Snapshot} using {@link CommonQueryExecutor}
   *
   * @param queryExecutor query executor
   * @return future of number of Snapshot deleted
   */
  public static Future<Integer> deleteAll(CommonQueryExecutor queryExecutor) {
    return queryExecutor.execute(dsl -> dsl.deleteFrom(SNAPSHOTS_LB))
