...
public class SourceStorageStreamImpl implements SourceStorageStream {
  ...
  @Override
  public void postSourceStorageStreamMarcRecords(MarcRecordSearchRequest entity, Map<String, String> okapiHeaders, Handler<AsyncResult<Response>> asyncResultHandler, Context vertxContext) {
