...
public class MarcHoldingsMatchEventHandler extends AbstractMarcMatchEventHandler {
  ...
  @Autowired
  public MarcHoldingsMatchEventHandler(RecordDao recordDao, ConsortiumConfigurationCache consortiumConfigurationCache) {
    super(TypeConnection.MARC_HOLDINGS, recordDao, DI_SRS_MARC_HOLDINGS_RECORD_MATCHED,
      DI_SRS_MARC_HOLDINGS_RECORD_NOT_MATCHED, consortiumConfigurationCache);
  }
