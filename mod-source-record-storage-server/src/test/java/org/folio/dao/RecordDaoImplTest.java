...
public class RecordDaoImplTest extends AbstractLBServiceTest {
  ...
  public void setUp(TestContext context) throws IOException {
    ...
    SnapshotDaoUtil.save(postgresClientFactory.getQueryExecutor2(TENANT_ID), snapshot)
  ...
  public void shouldReturnMultipleRecordsOnGetMatchedRecordsIfMatchedRecordIdsNotSpecified(TestContext context) {
    ...
    Future<List<Record>> future = SnapshotDaoUtil.save(postgresClientFactory.getQueryExecutor2(TENANT_ID), copyRecordSnapshot)
  ...
  public void shouldReturnFalseWhenPreviousIndexersDeletionIsInProgress(TestContext context) {
    ...
    Future<Boolean> future = postgresClientFactory.getQueryExecutor2(TENANT_ID)
