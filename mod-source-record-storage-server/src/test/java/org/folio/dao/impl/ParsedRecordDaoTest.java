...
public class ParsedRecordDaoTest extends AbstractEntityDaoTest<ParsedRecord, ParsedRecordCollection, ParsedRecordQuery, ParsedRecordDao, ParsedRecordMocks> {
  ...
  @Override
  public ParsedRecordMocks initMocks() {
