...
public class SourceStorageBatchApiTest extends AbstractRestVerticleTest {
  ...
  private static final String SOURCE_STORAGE_BATCH_FETCH_PARSED_RECORDS_PATH = "/source-storage/batch/parsed-records/fetch";
  ...
  public void setUp(TestContext context) {
    ...
    SnapshotDaoUtil.deleteAll(PostgresClientFactory.getQueryExecutor2(vertx, TENANT_ID))
      .compose(v -> SnapshotDaoUtil.save(PostgresClientFactory.getQueryExecutor2(vertx, TENANT_ID), TestMocks.getSnapshots()))
      .onComplete(save -> {
        if (save.failed()) {
