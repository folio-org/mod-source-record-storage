...
public class MarcAuthorityMatchEventHandlerTest extends AbstractLBServiceTest {
  ...
  public void setUp(TestContext context) {
    ...
    SnapshotDaoUtil.save(postgresClientFactory.getQueryExecutor2(TENANT_ID), snapshots).onComplete(save -> {
      if (save.failed()) {
  ...
  public void cleanUp(TestContext context) {
    Async async = context.async();
    SnapshotDaoUtil.deleteAll(postgresClientFactory.getQueryExecutor2(TENANT_ID)).onComplete(delete -> {
      if (delete.failed()) {
