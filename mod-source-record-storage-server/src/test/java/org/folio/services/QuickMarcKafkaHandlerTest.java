...
public class QuickMarcKafkaHandlerTest extends AbstractLBServiceTest {
  ...
  private SendKeyValues<String, String> createRequest() throws IOException {
    ...
    Event event = new Event().withEventPayload(ZIPArchiver.zip(Json.encode(payloadContext)));
